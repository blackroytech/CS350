...
class CWMachine(StateMachine):
    ...
    def on_enter_dot(self):
        ...
        ##.blink(.5,0,1,False) do not use pulse
    ...
    def on_enter_dash(self):
        ...
        ## use .blink(1.5,0,1,False) do not use pulse
    ...
    def toggleMessage(self):
        ...
        ## primary message = msg 1 backup = msg2
            ...
            for word in wordList:
                ...
                for char in word:
                    ...
                    for x in morse:
                        ...
                        ## Dot or dash?
                        if(x=='.'):
                            ##send twice to go back to off state
                            self.send("doDot")
                            self.send("doDot")
                        else:
                            ##dash
