...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_off(self):
             ...
             # indicator lights when entering the off state for both lights.
        redLight.off()
        blueLight.off()
  ...
  # decrease sepoint increase by 1
    ...
    def updateLights(self):
        ...
        ## if the state is heat 
        if self.current_state == self.heat:
            ## if below the set point let it fade
        ...
        ## if state is cool
            ...
            ## if above the setpoitn let it fade
            if temp > self.setPoint:
                    blueLight.pulse()
            else:
                    ## turn on blue light
    ...
    def setupSerialOutput(self):
        ...
        #assign out to display on UART
        # current state, temp in F, current setpoint, and temp in f
        # add newline at end

        output = f"{self.current_state.id}, {self.getFahrenheit()}, {self.setPoint}, {self.getFahrenheit()}\n"
        return output
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            #current time
            lcd_line_1 = current_time.strftime("%H:%M:%S")
            ...
            if(altCounter < 6):
                ...
                # current temp 
                lcd_line_2 = f"Current Temp: {self.getFahrenheit()}F"
                altCounter = altCounter + 1
            else:
                
                #current state and current temp set point
            ...
            if((counter % 30) == 0):
                ...
                message = self.setupSerialOutput()
